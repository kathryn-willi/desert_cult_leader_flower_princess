...
<div class="container" id="mainContainer" style="display: none;">
    ...
    <div id="welcome" class="tab-content active">
        <div class="welcome-content">
            ...
            <p>Get ready for art galleries, cowgirl nights out, surprise activities, wine tours, hot springs, hiking, and all the sass you can handle. This is her last ride before she takes his name, and we're making it unforgettable.</p>
    ...
    <div id="itinerary" class="tab-content">
        ...
        <div class="day-section">
            ...
            <div class="activity">
                <div class="activity-time">MIDDAY</div>
                <div class="activity-name">🛒 Grocery Haul</div>
                <div class="activity-details">Stock the homestead for the weekend</div>
            </div>
            <div class="activity">
            ...
            <div class="activity">
                <div class="activity-time">EVENING</div>
                <div class="activity-name">🍽️ Dinner Out</div>
        ...
        <div class="day-section">
            ...
            <div class="activity">
                ...
                <div class="activity-name">🧖 Scenic Taos Route Home</div>
    ...
    <div id="packing" class="tab-content">
        ...
        <div id="beltaneOverlay" class="password-overlay" style="position: relative; background: none; margin-bottom: 30px; z-index: 10;">
            <div class="password-modal" style="max-width: 600px; padding: 30px; margin: 0 auto;">
                <h1 style="color: #8b6f47; margin-bottom: 20px;">✨ DN Brides Allowed!✨</h1>
    ...
    <div id="blog" class="tab-content">
        ...
        <div class="day-section" id="blog-beltane">
            ...
            <p style="color: #5c4033; line-height: 1.8; margin-bottom: 15px;">We are arriving in Santa Fe on the exact date of <strong>Beltane</strong>—May 1st—one of the most sacred celebrations in the ancient Celtic calendar. This is not a coincidence.</p>
