...
<h1 style="color: #8b6f47; margin-bottom: 20px;">🤠 Enter Password 🤠</h1>
...
<button class="tab-button" data-tab="staying">Where We're Staying</button>
...
<p>You're invited to celebrate Carsen's last weekend of freedom in the magical desert town of Santa Fe, New Mexico!</p>
...
<div class="activity-details">Choose your adventure! Bring swimsuit and hiking gear. <a href="#" onclick="goToBlog('blog-nature'); return false;"><strong>See trail options →</strong></a></div>
</div>
...
<div class="activity">
<div class="activity-time">MORNING</div>
<div class="activity-name">✨ Surprise Activity ✨</div>
<div class="activity-details"><strong>You'll just have to wait and see...!</strong></div>
</div>
<div class="activity">
<div class="activity-time">8:00 AM – 6:00 PM</div>
...
<div class="activity-details">Stop at Ojo Caliente Mineral Springs for a long soak & a slow farewell to the desert</div>
</div>
</div>

<div class="notes">
<strong>💕 Here's to the last ride before she takes his name!</strong>
</div>
</div>
...
<h2>Desert Magic & History 🌙✨</h2>

<!-- WHERE TO EXPLORE NATURE -->
<div class="day-section" id="blog-nature">
<div class="day-title">🥾 Where to Explore Nature 🌲</div>
<p style="color: #5c4033; line-height: 1.8; margin-bottom: 15px;">Friday morning is your "choose your adventure" hike day. Pick a trail based on how far you want to drive and what kind of experience you're after—a hot springs soak, a peak summit, or a quick local loop. Bring swimsuit, hiking shoes, water, and sunscreen.</p>
...
<div class="notes">
<strong>🌵 Choosing your trail:</strong> Want to soak? Spence. Want to soak + hike? McCauley. Want a peak? Atalaya. Want short and local? Chamisa. Check current conditions before you go—high desert weather changes fast.
</div>
</div>
...
<p style="color: #5c4033; line-height: 1.8; margin-bottom: 15px;">We re-ran our satellite-based bloom model with the most recent data (NDVI through March 22, 2026; climate through April 25, 2026). Here's the latest forecast for what the Santa Fe desert will look like during your weekend:</p>

<h4 style="color: #c08552; margin-top: 20px; margin-bottom: 10px;">📊 The Science of May Blooms</h4>
<p style="color: #5c4033; line-height: 1.8; margin-bottom: 15px;">We analyzed 11 years of MODIS satellite data (2015–2025) to predict what the desert will look like April 23 – May 8, 2026 (the 16-day composite covering your weekend). The model tracks landscape "greenness" (NDVI), driven by winter water-year precipitation and March–April temperatures—the strongest predictors of spring bloom intensity.</p>

<h4 style="color: #c08552; margin-top: 20px; margin-bottom: 10px;">✨ 2026 Spring Bloom Prediction (Updated)</h4>
...
<p style="color: #5c4033; line-height: 1.8; margin-bottom: 15px;">Predicted peak NDVI date: <strong>~May 15, 2026</strong> (DOY 135). That's about <strong>13 days AFTER your weekend</strong>—you'll be arriving slightly before the seasonal peak, with the landscape still on the upswing.</p>
...
<h4 style="color: #c08552; margin-top: 20px; margin-bottom: 10px;">🌸 What You'll Actually See</h4>
...
<strong style="font-size: 1.2em;">🌙 You're arriving at the perfect time—spring's full magic, Beltane's sacred threshold, and wine to celebrate it all. ✨</strong>
</div>
</div>
